...
-- The Macchiato palette is available as a module. To use it, uncomment
-- the next line and replace a color below, for example:
...
-- Curves, see https://wiki.hypr.land/Configuring/Advanced-and-Cool/Animations/#curves
